...
/**
 * SimpleException is a class that constucts an exception with message that is composed from a list
 * of object values using the standard String.Format syntax. No conversions are made until the
 * constructor is calls, and at that time the values are embedded into the complete message.
 *
 * <p>It allows for chaining exceptions together.
 *
 * <p>It has a useful stack trace report that truncates the trace at the point where the trace
 * request was called, eliminating much of the useless trace lines.
 *
 * <p>This class does not provide support for translating the message to other languages with a
 * template and array of separate values.
 */
public class SimpleException extends RuntimeException {
    ...
    /**
     * Constructs a SimpleException with an explanatory message. Wraps the passed throwable as the
     * 'cause' exception.
     *
     * @param message Detail about the reason for the exception.
     */
