...
public class JSONWriter {
     ...
     *
     * @return this
     * @throws SimpleException If the nesting is too deep, or if the object is started in the wrong
     ...
     * @return this
     * @throws SimpleException If the key is out of place. For example, keys do not belong in arrays
