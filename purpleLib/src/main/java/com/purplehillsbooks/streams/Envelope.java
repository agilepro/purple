...
/**
 * This is for an envelope sort. Needed when you have a collection of objects but the objects
 * themselves don't know the order, instead the order is specified externally and might or might not
 * be provided.
 *
 * <p>In order to sort them, make a list of Envelope&lt;MyClass&gt; objects and specify the sort
