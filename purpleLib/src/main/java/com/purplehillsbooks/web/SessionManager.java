...
public class SessionManager implements HttpSessionListener {
    ...
    private SessionManager(ServletContext _sc) {
        try {
            ...
            throw new SimpleException("Unable to initialize the server, something is probably wrong with "
	...
	public File getAppDataFolder() {
	    try {
    	    ...
    	    if (!webInfFolder.exists()) {
    	        throw new SimpleException("For some reason webInfFolder (%s) does not exist!", webInfFolder.getAbsoluteFile());
    	    }
	...
	public JSONObject getConfigSettings() {
	    ...
	    if (!appConfigFile.exists()) {
	        throw new SimpleException("Config File (%s) does not exist!", appConfigFile.getAbsoluteFile());
	    }
